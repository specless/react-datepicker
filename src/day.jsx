...
import {getDate, getDay, getDayOfWeekCode, getMonth, isDayDisabled, isDayInRange, isSameDay, now} from "./date_utils";
    ...
    getClassNames = date => {
        ...
        return classnames(
            ...
            "react-datepicker__day--" + getDayOfWeekCode(this.props.day),
            {
                ...
                "sp-bg-color-primary": this.isSameDay(this.props.selected),
            },
